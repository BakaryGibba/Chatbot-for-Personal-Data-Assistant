...
def process_message_route():
    ...
    try:
        ...
        bot_response = f"Error processing user message: {e}"
...
def process_document_route():
    ...
    try:
        ...
        bot_response = "Thank you for providing your PDF document. I have analyzed it, so now you can ask me any questions regarding it!"
    except Exception as e:
        bot_response = f"Error processing document: {e}"
